...
- [Frontière serveur IA Replit sur Render](replit-ai-render-boundary.md) — l’IA Replit passe par l’API OpenAI-compatible côté serveur, avec credentials synchronisés vers Render sans exposition.
