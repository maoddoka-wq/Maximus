...
**How to apply:** ajouter un mode preview explicite aux écrans qui dépendent de données tenant, leur fournir un store synthétique vide et un mutateur inactif, puis désactiver les écritures et les appels API pendant le test du module ou du pack.