...
function CartPanel({ cart, total, store, customer, form, setForm, onChange, onSubmit, onBack }: { cart: CartLine[]; total: number; store: PublicShopBootstrap['store']; customer: EcommerceCustomer | null; form: { customerName: string; customerEmail: string; customerPhone: string; paymentMethod: 'WAVE' | 'ORANGE_MONEY'; shippingAddress: string; note: string }; setForm: (form: { customerName: string; customerEmail: string; customerPhone: string; paymentMethod: 'WAVE' | 'ORANGE_MONEY'; shippingAddress: string; note: string }) => void; onChange: (slug: string, delta: number) => void; onSubmit: () => void; onBack: () => void }) {
