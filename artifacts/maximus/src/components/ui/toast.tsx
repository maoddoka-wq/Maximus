...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed inset-x-0 bottom-0 z-[110] flex max-h-screen w-full flex-col-reverse gap-2 p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] sm:inset-x-auto sm:right-0 sm:flex-col sm:gap-0 sm:pb-4 md:max-w-[420px]',
      className,
    )}
    {...props}
  />
