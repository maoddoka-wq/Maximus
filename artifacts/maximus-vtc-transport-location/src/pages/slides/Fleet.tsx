export default function Fleet() {
  return (
    <div className='deck-bg deck-grid relative w-screen h-screen overflow-hidden text-text'>
      ...
      <span className='absolute right-[7vw] top-[6.8vh] font-body text-[1.45vw] font-semibold tracking-[0.14em] text-muted'>04 / 10</span>
