...
`artifacts/maximus-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/maximus-design-system/lib/native-theme` and
  `@workspace/maximus-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/maximus-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/maximus-design-system` and retains only
