...
- Export source : `Slider`
- Chemin source : `artifacts/maximus/src/components/ui/slider.tsx`
- Dépendances : @radix-ui/react-slider; cn
...
Implémentation : piste, plage et thumb Radix, avec valeur contrôlée dans la story `slider`.