...
- Chemin source : `artifacts/maximus/src/components/ui/switch.tsx`
- Dépendances : @radix-ui/react-switch; cn
...
Implémentation : switch Radix contrôlable, états checked/unchecked et focus visible; story `switch`.