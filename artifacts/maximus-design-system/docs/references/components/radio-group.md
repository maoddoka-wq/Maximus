...
- Export source : `RadioGroup, RadioGroupItem`
- Chemin source : `artifacts/maximus/src/components/ui/radio-group.tsx`
- Dépendances : @radix-ui/react-radio-group; Lucide; cn
...
Implémentation : groupe Radix et items circulaires avec indicateur Lucide; story `radio-group`.