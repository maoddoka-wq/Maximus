...
- Export source : `Collapsible, CollapsibleTrigger, CollapsibleContent`
- Chemin source : `artifacts/maximus/src/components/ui/collapsible.tsx`
...
Implémentation : primitives Radix contrôlées et non contrôlées; story `collapsible`.