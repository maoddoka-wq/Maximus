...
- Dépendances : @radix-ui/react-slot; class-variance-authority; cn; internal UI consumers
- Usage direct : 1 fichier(s) — src/components/company-installation-access.tsx
...
Appels représentatifs : Also used internally by calendar, carousel, alert-dialog, pagination, sidebar, input-group, button-group.
## Contrat de build
...
Note source : Also used internally by calendar, carousel, alert-dialog, pagination, sidebar, input-group, button-group