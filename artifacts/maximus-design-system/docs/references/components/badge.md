...
- Export source : `BadgeProps, Badge, badgeVariants`
- Chemin source : `artifacts/maximus/src/components/ui/badge.tsx`
- Dépendances : class-variance-authority; cn
...
Appels représentatifs : CompanyInstallationAccess status/category labels.
## Contrat de build
...
Note source : CompanyInstallationAccess status/category labels