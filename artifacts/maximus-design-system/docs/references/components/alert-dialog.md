...
- Dépendances : @radix-ui/react-alert-dialog; internal Button; cn
...
Appels représentatifs : CompanyInstallationAccess confirmation flow.
## Contrat de build
...
Note source : CompanyInstallationAccess confirmation flow