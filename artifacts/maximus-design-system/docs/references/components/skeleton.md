...
- Usage direct : 1 fichier(s) — src/components/ui/sidebar.tsx only
...
Appels représentatifs : Only used by Sidebar internally.
## Contrat de build
...
Note source : Only used by Sidebar internally