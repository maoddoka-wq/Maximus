...
- Dépendances : Button; Separator; class-variance-authority; cn
...
Appels représentatifs : Source ButtonGroup composes Button and Separator.
## Contrat de build
...
Note source : Source ButtonGroup composes Button and Separator