...
- Export source : `Progress`
- Chemin source : `artifacts/maximus/src/components/ui/progress.tsx`
...
Implémentation : barre Radix avec valeur et translation de l’indicateur; story `progress`.