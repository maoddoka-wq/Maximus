...
- Export source : `Card, CardHeader, CardFooter, CardTitle, CardDescription, CardContent`
- Chemin source : `artifacts/maximus/src/components/ui/card.tsx`
- Dépendances : cn utility
...
Appels représentatifs : CompanyInstallationAccess summary surface.
## Contrat de build
...
Note source : CompanyInstallationAccess summary surface