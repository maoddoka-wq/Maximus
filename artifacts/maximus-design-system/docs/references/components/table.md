...
- Dépendances : cn utility; distinct from app-ui DataTable
...
Appels représentatifs : App uses app-ui DataTable instead.
## Contrat de build
...
Note source : App uses app-ui DataTable instead