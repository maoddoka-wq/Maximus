...
- Dépendances : StoreData activity shape (type-only; local public prop type required); CSS tokens
...
Appels représentatifs : App.tsx:2823, 3204.
## Contrat de build
