...
- Chemin source : `artifacts/maximus/src/components/ui/toaster.tsx`
- Dépendances : Toast; use-toast hook
...
Appels représentatifs : App.tsx mounts the local toast host.
## Contrat de build
...
Note source : App.tsx mounts the local toast host