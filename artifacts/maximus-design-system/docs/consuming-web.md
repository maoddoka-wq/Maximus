# Consuming MAXIMUS Design System in web apps

Read `artifacts/maximus-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/maximus-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/maximus-design-system/styles.css";
```
...
`node_modules/@workspace/maximus-design-system/src/components` to `content`.
...
import { cn } from "@workspace/maximus-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/maximus-design-system/hooks/use-toast";
```
...
`@workspace/maximus-design-system/components/ui/button`. Run the app's typecheck
