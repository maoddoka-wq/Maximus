...
`artifacts/maximus-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { nativeTheme } from "@workspace/maximus-design-system/lib/native-theme";
import { useColors } from "@workspace/maximus-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/maximus-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/maximus-design-system/components/native/badge";
import { Button } from "@workspace/maximus-design-system/components/native/button";
import { Card } from "@workspace/maximus-design-system/components/native/card";
```
...
Import and render
`@workspace/maximus-design-system/components/native/button`, then run Expo
