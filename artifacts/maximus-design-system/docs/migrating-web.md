# Migrating web UI to MAXIMUS Design System

Read `artifacts/maximus-design-system/docs/AGENTS.md` and
`artifacts/maximus-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/maximus-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/maximus-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/maximus-design-system/hooks/use-toast`
