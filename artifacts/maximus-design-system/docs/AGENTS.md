...
workspace package (`@workspace/maximus-design-system`): other artifacts depend
...
`@workspace/maximus-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/maximus-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/maximus-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/maximus-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/maximus-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/maximus-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/maximus-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/maximus-design-system/docs/migrating-expo.md`
