# Migrating Expo UI to MAXIMUS Transport Public

Read `artifacts/maximus-transport-public/docs/AGENTS.md` and
`artifacts/maximus-transport-public/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/maximus-transport-public/lib/native-theme` and
  `@workspace/maximus-transport-public/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/maximus-transport-public/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/maximus-transport-public` and retains only
