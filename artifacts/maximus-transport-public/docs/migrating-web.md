# Migrating web UI to MAXIMUS Transport Public

Read `artifacts/maximus-transport-public/docs/AGENTS.md` and
`artifacts/maximus-transport-public/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/maximus-transport-public/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/maximus-transport-public/lib/utils`
- `@/hooks/use-toast` → `@workspace/maximus-transport-public/hooks/use-toast`
