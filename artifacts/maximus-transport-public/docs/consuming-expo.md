# Consuming MAXIMUS Transport Public in Expo apps

Read `artifacts/maximus-transport-public/docs/AGENTS.md` first. React Native does
...
`artifacts/maximus-transport-public/docs/migrating-expo.md` before writing UI.
...
```tsx
import { nativeTheme } from "@workspace/maximus-transport-public/lib/native-theme";
import { useColors } from "@workspace/maximus-transport-public/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/maximus-transport-public/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/maximus-transport-public/components/native/badge";
import { Button } from "@workspace/maximus-transport-public/components/native/button";
import { Card } from "@workspace/maximus-transport-public/components/native/card";
```
...
Import and render
`@workspace/maximus-transport-public/components/native/button`, then run Expo
