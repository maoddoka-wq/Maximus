# MAXIMUS Transport Public design system
...
workspace package (`@workspace/maximus-transport-public`): other artifacts depend
...
- `public/maximus-mark.png` and `docs/references/logos/maximus-mark.png` —
  the MAXIMUS mark used in the style-guide header and logo preview.
...
- `docs/references/README.md` — source notes for the retained brand asset and
  the public Transport visual reference.
...
`@workspace/maximus-transport-public/components/...`. Never use a `@/` alias inside
...
for `@workspace/maximus-transport-public` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/maximus-transport-public` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/maximus-transport-public/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/maximus-transport-public/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/maximus-transport-public/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/maximus-transport-public/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/maximus-transport-public/docs/migrating-expo.md`
