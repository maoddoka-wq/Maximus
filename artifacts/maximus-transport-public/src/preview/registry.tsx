...
export const DESIGN_SYSTEM = {
  title: 'MAXIMUS Transport Public',
  description:
    'Les repères visuels du parcours Taxi public MAXIMUS, de la réservation au suivi de course.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Vue d’ensemble',
  description: 'Les fondations visuelles du parcours Transport public.',
  Page: OverviewPage,
};
...
export const NAV_GROUPS: NavGroup[] = [
    ...
    entries: [
      {
        id: 'brand-logo',
        name: 'Logo MAXIMUS',
        description: 'Le signe de marque sur les surfaces claires et foncées.',
        Page: LogoPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Ambre taxi, bleu nuit MAXIMUS et couleurs de surface.',
        Page: ColorsPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Les caractères de l’interface, des métriques et des titres.',
        Page: FontsPage,
      },
    ],
  },
  {
    ...
    entries: [
      {
        id: 'spacing-radius',
        name: 'Espacement et arrondis',
        description: 'Le rythme de mise en page et les surfaces du système.',
        Page: LayoutPage,
      },
    ],
  },
  ...
  {
    name: 'Fenêtres et superpositions',
    entries: [
      {
        id: 'dialog',
        name: 'Dialog',
  ...
  { name: 'Exemples appliqués', entries: [] },
];
