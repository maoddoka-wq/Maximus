...
Route::get('/shop/{slug}/transport/history', [TransportController::class, 'customerTripHistory'])->middleware('throttle:orders');
Route::post('/shop/{slug}/transport/trips/{id}/cancel', [TransportController::class, 'cancelCustomerTrip'])->middleware('throttle:orders');
...
Route::get('/shop-domain/transport/history', [TransportController::class, 'customerDomainTripHistory'])->middleware('throttle:orders');
Route::post('/shop-domain/transport/trips/{id}/cancel', [TransportController::class, 'cancelCustomerDomainTrip'])->middleware('throttle:orders');
