...
final class OpenAIAssistantService
{
    ...
    private function systemPrompt(array $context): string
    {
        return implode("\n", [
            ...
            'Dans MAXI, les actions contrôlées autorisées sont la création de modules, packs, fonctionnalités, secteurs et plans de configuration, ainsi que la modification des informations d’une entreprise existante.',
            ...
            'Tu peux recommander ou préparer une proposition. Les actions autorisées passent par un aperçu serveur et une confirmation humaine explicite ; tu ne contournes jamais les validations et tu ne publies jamais automatiquement le catalogue.',
