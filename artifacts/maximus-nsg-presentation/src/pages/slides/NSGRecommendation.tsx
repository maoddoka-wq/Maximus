    ...
    <div className="relative h-screen w-screen overflow-hidden bg-bg font-body text-text">
      ...
      <div className="relative flex h-full w-full flex-col px-[8vw] pt-[15vh] pb-[7vh]">
        ...
        <p className="mt-[1.5vh] text-[1.9vw] leading-[1.25] text-muted">
          Sélection proposée à partir des activités décrites ; les conditions d’usage sont précisées ci-dessous.
        </p>
        <div className="mt-[3.5vh] grid flex-1 grid-cols-2 grid-rows-2 gap-[1.2vw]">
          <div className="border border-accent/40 bg-accent/10 p-[1.7vw]">
            <p className="text-[1.4vw] font-semibold uppercase tracking-[0.18em] text-accent">À PRIORISER</p>
            ...
            <p className="mt-[1vh] text-[1.85vw] leading-[1.25] text-muted">
              Clients, devis, ventes, factures, achats et suivi commercial.
            </p>
          </div>
          <div className="border border-white/10 bg-surface/85 p-[1.7vw]">
            <p className="text-[1.4vw] font-semibold uppercase tracking-[0.18em] text-accent">ÉQUIPES</p>
            <h3 className="mt-[1.2vh] font-display text-[2.5vw] font-semibold">Présences + Paie</h3>
            <p className="mt-[1vh] text-[1.85vw] leading-[1.25] text-muted">
              Pointage et suivi des absences, puis préparation et suivi de la paie.
            </p>
          </div>
          <div className="border border-white/10 bg-surface/85 p-[1.7vw]">
            <p className="text-[1.4vw] font-semibold uppercase tracking-[0.18em] text-accent">À CONFIRMER</p>
            <h3 className="mt-[1.2vh] font-display text-[2.5vw] font-semibold">Gestion de stock</h3>
            <p className="mt-[1vh] text-[1.85vw] leading-[1.25] text-muted">
              À activer si NSG souhaite suivre des articles, des équipements ou des marchandises stockés.
            </p>
          </div>
          <div className="border border-white/10 bg-surface/85 p-[1.7vw]">
            <p className="text-[1.4vw] font-semibold uppercase tracking-[0.18em] text-muted">OPTION CONDITIONNELLE</p>
            <h3 className="mt-[1.2vh] font-display text-[2.5vw] font-semibold">E-commerce</h3>
            <p className="mt-[1vh] text-[1.85vw] leading-[1.25] text-muted">
              À considérer uniquement si NSG veut vendre des produits directement en ligne.
            </p>
          </div>
        </div>
        <div className="flex justify-between pt-[1.5vh] text-[1.4vw] uppercase tracking-[0.16em] text-muted">
          <span>Les rôles et permissions complètent cette configuration</span>
          <span>03 / 12</span>
        </div>
      </div>
    </div>
