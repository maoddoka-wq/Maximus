      ...
      <div className="relative grid h-full w-full grid-cols-2 gap-[4vw] px-[8vw] pt-[16vh] pb-[8vh]">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-[1.8vh] text-[2vw] leading-[1.3] text-muted">
            D’après le profil fourni pour Némadi Services Group.
          </p>
          <div className="mt-[3.5vh] space-y-[1.6vh] text-[2vw] leading-[1.24]">
            ...
            <p><span className="mr-[0.7vw] text-accent">02</span>Opérations d’import et d’export</p>
        ...
        <div className="relative min-h-0 overflow-hidden border border-white/10 bg-surface">
          <img
            ...
            alt="Port et conteneurs illustrant le contexte d’activité de NSG"
          />
          <div className="absolute inset-0 bg-[linear-gradient(0deg,rgba(11,20,36,0.92)_0%,rgba(11,20,36,0.05)_62%)]" />
          <div className="absolute bottom-[3vh] left-[2vw] right-[2vw]">
            <p className="text-[1.4vw] font-semibold uppercase tracking-[0.18em] text-accent">NÉMADI SERVICES GROUP</p>
            <p className="mt-[0.8vh] font-display text-[2.6vw] font-semibold leading-[1.1]">
              Une proposition centrée sur la gestion de l’entreprise.
            </p>
          </div>
        </div>
